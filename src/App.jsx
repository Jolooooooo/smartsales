  ...
  return (
    <div className="login-wrap">
      <div className="login-card">
        <div className="login-logo">SmartSales</div>
    ...
    <div>
      ...
      <div style={{ background: "white", color: "black", padding: 32, borderRadius: 12 }}>
        <div style={{ textAlign: "center", marginBottom: 24 }}>
          <div style={{ fontSize: 22, fontWeight: 800, marginBottom: 4 }}>SmartSales — Sales Report</div>
        ...
        <div style={{ marginTop: 24, fontSize: 11, color: "#aaa", textAlign: "center" }}>Generated by SmartSales · {new Date().toLocaleDateString()}</div>
      </div>
    </div>
  );
...
function HelpPage() {
  ...
  return (
    <div>
      <div className="page-header"><div className="page-title">Help & Instructions</div><div className="page-sub">Step-by-step guide to using SmartSales</div></div>
      {sections.map((sec, si) => (
...
export default function App() {
  ...
  if (loading) return (<><style>{CSS}</style><div className="loading-screen"><div className="spinner"></div><div style={{ color: "var(--muted)", fontSize: 13 }}>Loading SmartSales...</div></div></>);
    ...
    <>
      ...
      <div className="app">
        <nav className="sidebar">
          <div className="sidebar-logo">Smart<span>Sales</span></div>
